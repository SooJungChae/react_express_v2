...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Grid = __webpack_require__(158);
	...
	var Hello = function (_React$Component) {
	  ...
	  _createClass(Hello, [{
	    ...
	    value: function onSearch(e) {
	      ...
	      fetch('/user/' + this.state.searchText).then(function (res) {
	        return res.text();
	      }).then(function (members) {
	        _this3.setState({
	          members: JSON.parse(members)
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement('input', { id: 'searchText',
	        ...
	        _react2.default.createElement(_Grid2.default, { members: this.state.members }),
	        _react2.default.createElement(
	          'ul',
	          null,
	          mans
